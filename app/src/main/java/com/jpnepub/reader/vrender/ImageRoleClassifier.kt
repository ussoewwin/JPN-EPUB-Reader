 ...
 *
 * 手がかりの例:
 *  - EPUB CSS の慣習 class (gaiji, pagefit, inline, class_s3X, class_s2K7, class_sN-* 等)
...
internal object ImageRoleClassifier {
    ...
    /** 外字 img: class_s3[a-z0-9]+ 等 (suffix 無し)。挿絵: class_sN-1 等 suffix 付き。 */
    private val CLASS_S_GAIJI_IMG_RE = Regex("^class_s3[a-z0-9]+$")
    /** 外字 img: class_s2k[a-z0-9]+ 等 (128px, CSS 1em)。挿絵: class_s2F-1 等 suffix 付き。 */
